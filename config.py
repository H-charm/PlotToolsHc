...
class Config:
  ...
  def __init__(self):  
    ...
    self.vars_Z =[
      # [self.Z_prefix + "mass","Z_mass","m(ll) [GeV]", 24, 60, 120],
      # [self.Z_prefix + "pt","Z_pt","p_{T}(ll) [GeV]", [0,25,50,75,100,125,150,175,200,225,250,275,300,325,350,375,400,450,500,550,600,700,800,1000]],
      # [self.Z_prefix + "eta","Z_eta","#eta(ll)", 48, -2.4, 2.4],
      # [self.Z_prefix + "phi","Z_phi","#phi(ll)", 40, -4, 4],
      # [self.Z_prefix + "dR","Z_dR","#DeltaR", 30, 0, 3],
      # [self.Z_prefix + "lep1_pt","Lep1_pt","p_{T}(l_{1}) [GeV]",[0,25,50,75,100,125,150,175,200,250,300,500]],
      # [self.Z_prefix + "lep1_eta","Lep1_eta","#eta(l_{1})", 48, -2.4, 2.4],
      # [self.Z_prefix + "lep1_phi","Lep1_phi","#phi(l_{1})", 40, -4, 4],
      # [self.Z_prefix + "lep2_pt","Lep2_pt","p_{T}(l_{2}) [GeV]", [0,25,50,75,100,125,150,175,200,250,300,500]],
      # [self.Z_prefix + "lep2_eta","Lep2_eta","#eta(l_{2})", 48, -2.4, 2.4],
      # [self.Z_prefix + "lep2_phi","Lep2_phi","#phi(l_{2})", 40, -4, 4],

      [self.Zmu_prefix + "mass","Z_mass_2mu","m(#mu#mu) [GeV]", 24, 60, 120],
      # [self.Zmu_prefix + "pt","Z_pt_2mu","p_{T}(#mu#mu) [GeV]", [0,25,50,75,100,125,150,175,200,225,250,275,300,325,350,375,400,450,500,550,600,700,800,1000]],
      # [self.Zmu_prefix + "eta","Z_eta_2mu","#eta(#mu#mu)", 48, -2.4, 2.4],
      # [self.Zmu_prefix + "phi","Z_phi_2mu","#phi(#mu#mu)", 40, -4, 4],
      # [self.Zmu_prefix + "dR","Z_dR_2mu","#DeltaR", 30, 0, 3],
      # [self.Zmu_prefix + "lep1_pt","Lep1_pt_2mu","p_{T}(#mu_{1}) [GeV]",[0,25,50,75,100,125,150,175,200,250,300,500]],
      # [self.Zmu_prefix + "lep1_eta","Lep1_eta_2mu","#eta(#mu_{1})", 48, -2.4, 2.4],
      # [self.Zmu_prefix + "lep1_phi","Lep1_phi_2mu","#phi(#mu_{1})", 40, -4, 4],
      # [self.Zmu_prefix + "lep2_pt","Lep2_pt_2mu","p_{T}(#mu_{2}) [GeV]", [0,25,50,75,100,125,150,175,200,250,300,500]],
      # [self.Zmu_prefix + "lep2_eta","Lep2_eta_2mu","#eta(#mu_{2})", 48, -2.4, 2.4],
      # [self.Zmu_prefix + "lep2_phi","Lep2_phi_2mu","#phi(#mu_{2})", 40, -4, 4],

      # [self.Zel_prefix + "mass","Z_mass_2e","m(ee) [GeV]", 24, 60, 120],
      # [self.Zel_prefix + "pt","Z_pt_2e","p_{T}(ee) [GeV]", [0,25,50,75,100,125,150,175,200,225,250,275,300,325,350,375,400,450,500,550,600,700,800,1000]],
      # [self.Zel_prefix + "eta","Z_eta_2e","#eta(ee)", 48, -2.4, 2.4],
      # [self.Zel_prefix + "phi","Z_phi_2e","#phi(ee)", 40, -4, 4],
      # [self.Zel_prefix + "dR","Z_dR_2e","#DeltaR", 30, 0, 3],
      # [self.Zel_prefix + "lep1_pt","Lep1_pt_2e","p_{T}(e_{1}) [GeV]",[0,25,50,75,100,125,150,175,200,250,300,500]],
      # [self.Zel_prefix + "lep1_eta","Lep1_eta_2e","#eta(e_{1})", 48, -2.4, 2.4],
      # [self.Zel_prefix + "lep1_phi","Lep1_phi_2e","#phi(e_{1})", 40, -4, 4],
      # [self.Zel_prefix + "lep2_pt","Lep2_pt_2e","p_{T}(e_{2}) [GeV]", [0,25,50,75,100,125,150,175,200,250,300,500]],
      # [self.Zel_prefix + "lep2_eta","Lep2_eta_2e","#eta(e_{2})", 48, -2.4, 2.4],
      # [self.Zel_prefix + "lep2_phi","Lep2_phi_2e","#phi(e_{2})", 40, -4, 4],
    ]
    
    self.output_plots_dir = "plots/trees_17_07/2022_Combined"
    self.base_dir = "/eos/user/n/nplastir/H+c/trees_17_07/mc/2022_Combined"
    self.cuts = "1" # if you don't want cuts remember to put "1"
    self.weights =  "genWeight * xsecWeight * lumiwgt * puWeight * muEffWeight * elEffWeight " #elTriggerSFWeight" #*elHLTWeightData/elHLTWeight" # elTriggerWeightData/elTriggerWeight " #*elTriggerWeight * muTriggerWeight " # *muHLT * elHLT" #* elHLTWeight * muHLTWeight" #elHLTWeight" #  muHLTWeight * muHLT * elHL" #* elHLTWeight * muHLTWeight" #"LHEScaleWeightNorm * LHEPdfWeightNorm * PSWeightNorm"
    self.weights_up = "genWeight * xsecWeight * lumiwgt * puWeightUp * muEffWeightUp * elEffWeightUp * muHLTUp * elTriggerWeightUp"
    self.weights_down = "genWeight * xsecWeight * lumiwgt * puWeightDn * muEffWeightDown * elEffWeightDown * elTriggerWeightDown * muHLTDown"
